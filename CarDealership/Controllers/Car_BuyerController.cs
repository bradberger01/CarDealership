...
namespace CarDealership.Controllers
{
    public class Car_BuyerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Car_BuyersID,CarID,BuyerID")] Car_Buyer car_Buyer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Car_BuyersID,CarID,BuyerID")] Car_Buyer car_Buyer)
        {
            if (ModelState.IsValid)
            {
